		...
		return (
			<div className={ this.classNameRoot() }>
				<MarkupSection title={ 'Ui Kit - Typography' }>
					...
					<p>
						Задача <BaseLink href={ 'https://google.com' } target={ '_blank' }>организации</BaseLink>, в особенности же постоянный количественный рост и сфера нашей активности
...
PageUiKitTypography.propTypes = { className: PropTypes.node };
