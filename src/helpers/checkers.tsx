/**
 * Checks if specified value has a boolean type
 ...
 */
export const isBoolean: ( value: unknown, excludeFalsy?: boolean ) => boolean = ( value, excludeFalsy ) => {
	const isType = typeof value === 'boolean';
...
/**
 * Checks if specified value is an instance of FormData
 * @param {unknown} value - a value for check
 * @returns {boolean} - checking result
 */
export const isFormData: ( value: unknown ) => boolean = ( value ) => {
